...
function makeHarness() {
  ...
  new vm.Script(`${startCameraSource}; globalThis.__startCamera = startCamera;`).runInContext(context);
...
test('startCamera attaches a mocked calibration stream without invoking the game freshness gate', async () => {
  ...
  assert.equal(harness.videos.get('calibVideo').playCalls, 1);
