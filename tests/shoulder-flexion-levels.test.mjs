...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v95-20260902-level5-realtime-index-chopsticks/);
  assert.match(manifest,/v95-20260902-level5-realtime-index-chopsticks/);
  assert.match(worker,/v95-20260902-level5-realtime-index-chopsticks/);
