...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v108-20260907-peg-release-cheer-cartoons/);
  assert.match(manifest,/v108-20260907-peg-release-cheer-cartoons/);
  assert.match(worker,/v108-20260907-peg-release-cheer-cartoons/);
