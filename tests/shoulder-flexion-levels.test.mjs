...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v110-20260907-peg-hold-hysteresis-gate/);
  assert.match(manifest,/v110-20260907-peg-hold-hysteresis-gate/);
  assert.match(worker,/v110-20260907-peg-hold-hysteresis-gate/);
