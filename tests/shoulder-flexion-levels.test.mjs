...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v99-20260904-hand-check-switch-lock-privacy-blur/);
  assert.match(manifest,/v99-20260904-hand-check-switch-lock-privacy-blur/);
  assert.match(worker,/v99-20260904-hand-check-switch-lock-privacy-blur/);
