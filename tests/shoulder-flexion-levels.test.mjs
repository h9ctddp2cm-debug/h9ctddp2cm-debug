...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v113-20260912-public-no-certificate/);
  assert.match(manifest,/v113-20260912-public-no-certificate/);
  assert.match(worker,/v113-20260912-public-no-certificate/);
