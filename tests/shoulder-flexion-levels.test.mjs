...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v87-20260902-level6-tool-sensitivity-clear-fist/);
  assert.match(manifest,/v87-20260902-level6-tool-sensitivity-clear-fist/);
  assert.match(worker,/v87-20260902-level6-tool-sensitivity-clear-fist/);
