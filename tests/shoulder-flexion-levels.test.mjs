...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v109-20260907-cheer-cartoon-equal-height/);
  assert.match(manifest,/v109-20260907-cheer-cartoon-equal-height/);
  assert.match(worker,/v109-20260907-cheer-cartoon-equal-height/);
