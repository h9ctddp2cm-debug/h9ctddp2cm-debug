...
test('setup exposes distinct exact target-hold choices and aligns v51 source identifiers',()=>{
  ...
  assert.match(html,/v90-20260902-dimsum-flower-chopstick-fix/);
  assert.match(manifest,/v90-20260902-dimsum-flower-chopstick-fix/);
  assert.match(worker,/v90-20260902-dimsum-flower-chopstick-fix/);
