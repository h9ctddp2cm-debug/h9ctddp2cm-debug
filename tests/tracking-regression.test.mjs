...
test("portrait phones keep the camera inline in a compact preview instead of fullscreen", () => {
  ...
  assert.match(serviceWorkerSource, /fthue-rehab-v106-20260905-flowers-bowling-sign/);
});
...
test("offline worker forces the current build instead of serving the stale game", () => {
  ...
  assert.match(serviceWorkerSource, /fthue-rehab-v106-20260905-flowers-bowling-sign/);
  assert.ok(publicSource.includes('const LEVEL_APP_BUILD = "v106-20260905-flowers-bowling-sign"'));
  assert.equal(manifest.start_url, "./index.html?build=v106-20260905-flowers-bowling-sign");
