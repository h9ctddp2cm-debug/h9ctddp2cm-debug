(function () {
  ...
  const EN = {
    ...
    '兩級檯面承托訓練｜外展／內收 → 前伸畫圈':'Two graded tabletop activities: abduction/adduction, then forward reach and circles',
    ...
    '檯面前伸後畫圈':'Tabletop forward reach, then circles',
    '容易：肩水平外展（向外滑）':'Easier: shoulder horizontal abduction (outward slide)',
    ...
    '較難：肩屈曲及伸肘前伸，再作肩水平外展／內收畫圈':'Harder: forward shoulder flexion with elbow extension, followed by horizontal abduction/adduction circles',
