(function () {
  ...
  const EN = {
    ...
    '雙手患側外滑｜患臂承托滑動':'Bilateral outward slide or supported affected-arm movement',
    '桌面承托滑動':'Supported tabletop movement',
    '試玩':'Trial',
    '訓練':'Training',
    '詳情':'Details',
    '所有活動均在檯面承托下進行；由職業治療師選擇合適玩法':'All activities are completed with tabletop support; the occupational therapist selects the appropriate mode.',
    '包括好手帶患手向患側外滑，以及患臂承托的伸肘／水平外展活動':'Includes bilateral outward sliding and supported elbow-extension or horizontal-abduction activities.',
    ...
    '患臂離開桌面，每個物件按畫面由 0°、10° 或 20° 穩定起步':'Keep the affected arm off the table. Each object begins at a stable on-screen position of 0°, 10° or 20°.',
    '每個物件使用 0°／10°／20° 起點；治療師選擇 30°／40°／50°／60° 目標':'Objects start at 0°/10°/20°; the therapist selects a 30°/40°/50°/60° target.',
    ...
    '雙手患側外滑':'Bilateral affected-side slide',
    '抹窗擦霧':'Window wiping',
    '保齡球':'Bowling',
    '巴士拍卡':'Bus card tap',
